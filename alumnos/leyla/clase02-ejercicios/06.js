...
function odiar(dia, num) { // usar ternarios
    ...
    switch(dia) {
        case "lunes":
            mensaje = num === 12 ? "Si odio el número" : "No odio el número";
            break;
        case "martes":
            mensaje = num > 95 ? "Si odio el número" : "No odio el número";
            break;
        case "miercoles":
            mensaje = num === 34 ? "Si odio el número" : "No odio el número";
            break;
        case "jueves":
            mensaje = num === 0 ? "Si odio el número" : "No odio el número";
            break;
        case "viernes":
            mensaje = num % 2 === 0 ? "Si odio el número" : "No odio el número";
            break;
        case "sabado":
            mensaje = num === 56 ? "Si odio el número" : "No odio el número";
            break;
        case "domingo":
            mensaje = num === 666 || num === -666 ? "Si odio el número" : "No odio el número";
            break;
        default:
            mensaje = "No se reconoce el día. Inténtelo con otro nombre."
    }
